...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        //On utilise le singleton FirebaseApp
        FirebaseApp.configure()
        
        // On crée notre base de donnée
        // Là aussi on utilise ce je pense être un singleton Database.
        let myDatabase = Database.database().reference()
        
        // On fait un petit essie
//        myDatabase.setValue("Bonjour")
        // Si l'on garde ce test à chaque lancement de l'appli la base
        // est effacée car ici on attaque directement reference()
        // et pas child()
